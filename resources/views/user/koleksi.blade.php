                ...
                <div class="bg-[#2b1d13] border border-amber-900 rounded-3xl p-5 shadow-2xl">
                        ...
                        <div class="flex flex-col lg:flex-row gap-5">
                            <div class="flex-1 relative">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="w-5 h-5 absolute left-5 top-1/2 -translate-y-1/2 text-gray-500" fill="none"
                    ...
                    <div class="flex flex-wrap gap-4 mt-8">
                        ...
                        <a href="{{ request()->fullUrlWithQuery(['kategori' => null]) }}"
                            class="{{ !request('kategori') ? 'bg-amber-700 text-white' : 'bg-[#1a120b] border border-amber-900 text-gray-300 hover:border-amber-600' }} transition px-5 py-3 rounded-2xl text-center text-sm min-w-[100px]">
                            Semua
                        </a>
