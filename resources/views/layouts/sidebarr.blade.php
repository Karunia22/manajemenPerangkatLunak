...
<div id="sidebarOverlay" class="hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-40 lg:hidden transition-opacity duration-300"></div>
...
<aside id="sidebarAdmin"
    ...
    <div class="h-24 border-b border-amber-900/30 flex items-center justify-between pr-4 pl-8 bg-gradient-to-r from-[#24170f] to-[#1a120b] relative">
